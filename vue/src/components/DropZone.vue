...
export default {
    ...
    data(){
        return {
            ...
            //-------------------------------------------------------------------------------------
            dropzoneOptions: {
                url: "https://api.cloudinary.com/v1_1/df4fixoed/image/upload",  
                thumbnailWidth: 250,
                thumbnailHeight: 250,
                maxFilesize: 2.0,
    ...
    methods:{
        ...
        addFormData(file, xhr, formData) {
            formData.append("api_key", "128346365251797");                // substitute your api key
            formData.append("upload_preset", "dccfjlkr");   // substitute your upload preset
        ...
        getSuccess(file, response) {
            ...
            this.$store.state.userImage = imgUrl;
